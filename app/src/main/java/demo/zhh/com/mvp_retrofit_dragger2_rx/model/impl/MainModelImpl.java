...
public class MainModelImpl  extends BaseModel implements MainModel {
    ...
    public Subscription loadDataFromService(final RequestResult<PaperInfo> result) {
        return service.getPaper(1, "Xiaomi%28MI%204LTE%29", "05014648279f94ff80efc3655e09a6b4", 1, "1001", "60727212", 102, 0, 1, 1080, 1920, 2160, 1920, 76, "zh_CN", "", 0, 1, 3).subscribeOn(Schedulers.io()).subscribe(new Observer<PaperInfo>() {
            @Override
